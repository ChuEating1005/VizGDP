<template>
  <div>
    ...
    <!-- Map -->
    <svg id="map" width="1200" height="560"></svg>
    ...
    function highlightRange(range) {
      svg.selectAll("path")
        .attr("class", d => {
          ...
          if (range === "No data") {
            return countryData === undefined ? "country-highlight" : "country dimmed";
          } else {
...
<style>
  ...
  .no-data-item {
    ...
    margin-right: 20px;
    min-width: 80px; /* Ensure consistent width with other legend items */
